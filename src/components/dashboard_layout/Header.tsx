...
export default function Header() {
  return (
    <header className="header fixed top-0 left-0 right-0 m-3 z-50 lg:m-4 lg:pl-sidebar lg:[transition:padding_.4s]" id="header">
      <div className="header_container px-4 w-full h-header bg-background shadow-md flex justify-between items-center gap-x-4 rounded-2xl [transition:background-color_.4s] sm:px-6 lg:h-[calc(var(--header-height)_+_2rem)] lg:px-8">
