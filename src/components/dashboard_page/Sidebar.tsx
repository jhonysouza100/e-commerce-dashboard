...
const menuItems = [
  {
    section: "MANAGE",
    items: [
      { icon: <i>icon</i>, label: "Home", href: "/" },
      // { icon: RiGroupFill, label: TEXT.users, href: "/dashboard/users" },
      { icon: <i>icon</i>, label: "Productos", href: "/products" },
    ],
  },
  {
    section: "SETTINGS",
    items: [
      { icon: <i>icon</i>, label: "etc", href: "/etc" },
      { icon: <i>icon</i>, label: "etc", href: "/etc" },
      { icon: <i>icon</i>, label: "etc", href: "/etc" },
    ],
  },
